...
public class LibraryRecordServiceVertxEBProxy implements LibraryRecordService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public LibraryRecordServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public LibraryRecordServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  LibraryRecordService findByLibraryId(String libraryId, Handler<AsyncResult<JsonObject>> resultHandler){
    ...
    _json.put("libraryId", libraryId);

    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "findByLibraryId");
  ...
  public  LibraryRecordService addLibraryUser(String libraryId, Handler<AsyncResult<JsonObject>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "addLibraryUser");
    _vertx.eventBus().<JsonObject>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public  LibraryRecordService isSchoolUser(String libraryId, Handler<AsyncResult<Boolean>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "isSchoolUser");
